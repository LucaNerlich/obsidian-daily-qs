...
// Theme-tinted Obsidian mark drawn with PathSvg (same approach as stock
// Dropbox/Tailscale icons). Avoid Image+MultiEffect — colorization there
// paints a solid square over this SVG's alpha.
Item {
  id: root
  ...
  // Official simple-icons path is in a 24×24 viewBox.
  ...
  Shape {
    ...
    transform: Scale {
      xScale: root.iconSize / root.viewBox
      yScale: root.iconSize / root.viewBox
    }
